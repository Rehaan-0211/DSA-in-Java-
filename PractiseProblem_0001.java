...
//(Variables Section) Question1:In a program,input 3 numbers:A,BandC.You have t output the average of these 3 numbers.(Hint : Average of N numbers is sum of those numbers divided by N)
import java.util.*;

public class PractiseProblem_0001 {
